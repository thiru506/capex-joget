...
ProcessStatus.prototype = {
    ...
    autoLayout: function() {
        ...
        $(this.canvas).find(".process_container").each(function(){
            ...
            if (mode === "topToBottom") {
                ...
                $(pc).css("width", (g.graph().height + 100) + "px");
            }
        });
    ...
    drawProcess : function(processData, processContainer, startNodeLink, activeNodes, migratedSubProcess) {
        ...
        for (var a = 0; a < processData.activities.length; a++) {
            ...
            if ((migratedProcessData !== null || migratedSubProcess) && act.state === "closed.aborted" && actModel.type !== "subflow") {
                ...
                if (actModel.type === "activity") {
                    ...
                    var returnActId = this.drawProcess(subflowData, processContainer, tempActiveNode.links, null, migrated);
    ...
    createProcessContainer : function (processData, processModel) {
        ...
        this.inst[processData.process.instanceId] = ProcessBuilder.Util.jsPlumb.getInstance({
