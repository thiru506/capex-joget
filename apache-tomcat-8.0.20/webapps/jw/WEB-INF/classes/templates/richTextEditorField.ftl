...
<#else>
    ...
    <div class="form-clear"></div>
    <textarea id="${elementParamName!}_${element.properties.elementUniqueKey!}" name="${elementParamName!}" style='display:none;' <#if element.properties.readonly! == 'true'>readonly</#if>>${value!?html}</textarea>
